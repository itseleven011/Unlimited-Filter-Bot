...
async def cb_handler(client, query):
    ...
    if query.data == "start_data":
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Want To request movie/series?", url="https:/t.me/movieezzclub"),
                    InlineKeyboardButton("Dbaya Toh tu gadha", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("Main Channel", url="https://t.me/Moviezzclub"),
                    InlineKeyboardButton("Request Group", url="https://t.me/moviezzclub")
                ]
            ]
        )
            ...
            [
                [
                    InlineKeyboardButton(
                        "SOURCE CODE", url="https://t.me/nosourcecode")
                ],
                [
